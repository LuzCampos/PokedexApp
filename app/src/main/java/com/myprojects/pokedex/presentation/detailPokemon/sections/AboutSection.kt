package com.myprojects.pokedex.presentation.detailPokemon.sections
...
fun Breeding(pokemonui: PokemonUi, modifier: Modifier) {
    Column(verticalArrangement = Arrangement.SpaceBetween, modifier = modifier
        ...
        Text(modifier= Modifier.padding(vertical = 6.dp),text = stringResource(id = R.string.msg_about_breeding), fontWeight = FontWeight.ExtraBold, color = Color(0xFF8C9092))
...
fun GenderTextValue(gender:String, icono:Int) {
    Row(modifier = Modifier.padding(end = 14.dp) ,verticalAlignment = Alignment.CenterVertically) {
        ...
        Text( modifier = Modifier.padding(start = 2.dp) ,text = "$gender%", color = Color(0xff303943))
    }
}
...
fun Dimension(title:String, dimension:String){
    Column(
        ...
        Text(text = dimension, color = Color(0xff303943))
    }
}
